...
CSV
  ...
  describe "theshold definitions" do
    ...
    it "uses ect thresholds" do
      ...
      expect(thresholds[9]).to eq(6)
      expect(thresholds[10]).to eq(6)
      expect(thresholds[11]).to eq(6)
      expect(thresholds[12]).to eq(6)
      expect(thresholds[13]).to eq(6)
      expect(thresholds[14]).to eq(6)
      expect(thresholds[15]).to eq(6)
      expect(thresholds[16]).to eq(6)
      expect(thresholds[17]).to eq(6)
      expect(thresholds[18]).to eq(6)
      expect(thresholds[19]).to eq(6)
      expect(thresholds[20]).to eq(6)
      expect(thresholds[21]).to eq(6)
      expect(thresholds[22]).to eq(6)

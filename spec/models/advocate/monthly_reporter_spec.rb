...
CSV
    ...
    xdescribe "staffing_grid_for_day" do
  ...
  describe "theshold definitions" do
    it "uses the calculated thresholds" do
      ...
      expect(thresholds[19]).to eq(9)
      expect(thresholds[20]).to eq(9)
      expect(thresholds[21]).to eq(8)
      expect(thresholds[22]).to eq(8)
    ...
    it "uses ect thresholds" do
      ...
      expect(thresholds[9]).to eq(4)
      expect(thresholds[10]).to eq(4)
      ...
      expect(thresholds[3]).to eq(4)
      expect(thresholds[4]).to eq(4)
      expect(thresholds[5]).to eq(4)
      expect(thresholds[6]).to eq(4)
    end
  end
end
